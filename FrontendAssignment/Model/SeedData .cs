...
namespace FrontendAssignment.Model
{
    public class SeedData
    {
		...
		{
			using (var context = new FrontendAssignmentContext(
				serviceProvider.GetRequiredService<
					DbContextOptions<FrontendAssignmentContext>>()))
			{
				...
				context.Products.AddRange(
					...
					new Products
					{
						...
						Price = "169 kr",
						Clicks = 0,
						ImageSrc = "https://bilder.tidningskungen.se/upl/normal300/hemmets-journal-9-2020.jpg",
					...
					new Products
					{
						...
						Price = "159 kr",
						Clicks = 0,
						ImageSrc = "https://bilder.tidningskungen.se/upl/normal300/bamse-tidningsprenumeration-3-2020.jpg",
					...
					new Products
					{
						Title = "Kalle Anka & C=o",
						Price = "227 kr",
						Clicks = 0,
						ImageSrc = "https://bilder.tidningskungen.se/upl/normal300/kalle-anka--co-tidningsprenumeration-8-2020.jpg",
					...
					new Products
					{
						...
						Price = "188 kr",
						Clicks = 0,
						ImageSrc = "https://bilder.tidningskungen.se/upl/normal300/min-hast-6-2020.jpg",
					...
					new Products
					{
						...
						Price = "135 kr",
						Clicks = 0,
						ImageSrc = "https://bilder.tidningskungen.se/upl/normal300/kamratposten-2-2020.jpg",
					...
					new Products
					{
						...
						Price = "99 kr",
						Clicks = 0,
						ImageSrc = "https://bilder.tidningskungen.se/upl/normal300/allas-8-2020-2.jpg",
					...
					new Products
					{
						...
						Price = "99 kr",
						Clicks = 0,
						ImageSrc = "https://bilder.tidningskungen.se/upl/normal300/allers-9-2020.jpg",
					...
					new Products
					{
						...
						Price = "45 kr",
						Clicks = 0,
						ImageSrc = "https://bilder.tidningskungen.se/upl/normal300/rad--ron-2-2020.jpg",
						Description = ""
					},
					new Products
					{
						...
						Price = "99 kr",
						Clicks = 0,
						ImageSrc = "https://bilder.tidningskungen.se/upl/normal300/aret-runt-tidningsprenumeration-3-2020.jpg",
					...
					new Products
					{
						...
						Price = "79 kr",
						Clicks = 0,
						ImageSrc = "https://bilder.tidningskungen.se/upl/normal300/illustrerad-vetenskap-tidningsprenumeration-4-2020.jpg",
